...
- 9a6814d: `ScrollUnmaskImage`: give it an outer frame that owns the corner shape (squircle
...
- 0410194: Add squircle corners (`corner-shape: squircle`, progressively enhanced behind
